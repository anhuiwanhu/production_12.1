   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="toolbarBottomLine">  
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="listTable">
        ...
        <tr class="listTableHead">
			<td whir-options="field:'orgNameString',width:'25%'">组织</td> 
			...
			<td whir-options="field:'name',width:'10%'">合同类型</td> 
			<td whir-options="field:'endDate', width:'15%',renderer:common_DateFormat">合同到期日</td> 
        </tr>
		</thead>
