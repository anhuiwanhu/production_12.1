...
<body class="Pupwin">
	<div class="BodyMargin_10">
		...
		<div class="docBoxNoPanel">
			...
			<input type="hidden" name="newRecordId" id="newRecordId">
...
initDataFormToAjax({"dataForm":'dataForm',"queryForm":'queryForm',"tip":'<s:text name="info.newinfosave"/>',"callbackfunction":setRelation,"reset":"info"});
...
function infoPreView(){
	...
	var informationTitle = $('#informationTitle').val();//'<s:property value="information.informationTitle"/>';
...
//20160427 -by jqq保存草稿
function saveInfoDraft(flag,obj){
