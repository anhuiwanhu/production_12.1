...
if(fromGov.equals("2")){
	...
	moduleId = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(moduleId);
}
//20151010 -by jqq 
...
fromGov = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(fromGov);
channelId = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(channelId);
channelName = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(channelName);
userChannelName = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(userChannelName);
type = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(type);
original = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(original);
docNo = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(docNo);
title = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(title);
govId = com.whir.component.security.crypto.EncryptUtil.replaceHtmlcode(govId);
...
<body class="docBodyStyle" scroll="no" onload="initBody();">
    ...
    <div class="doc_Scroll">
		<s:form name="form" id="form" action="Information!add.action" method="post">
			...
			<input type="hidden" name="oldchannel" id="oldchannel">
		</s:form>
		<s:form name="dataForm" id="dataForm" action="wfoperate!showSend.action" method="post" theme="simple" >
			<table id="data-table" border="0"  cellpadding="0" cellspacing="0" height="100%" align="center" class="doc_width">
				<tr valign="top">
					<td height="100%">
						<div class="docbox_noline">
							...
							<div class="doc_Content docBoxNoPanel" >
								...
								<div>
									...
									<input type="hidden" name="relaFlag" id="relaFlag" value="0">
								</div>
								<!--工作流包含页-->
								<div>     
...
function saveInfoDraft(flag){
	...
	$("#informationVersion").val("0.01");
	document.getElementById("dataForm").action="Information!saveDraft.action";
	setCallBackName("");
	$("#dataForm").submit(); 
}
