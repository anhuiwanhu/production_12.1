	...
	<table width="586"  id="wf_c_mainTable" border="0" cellspacing="0" cellpadding="0" class="Table_bottomline" >
		...
		<tr class="Table_nobttomline"   id="remindTr">
			...
			<td style="text-align:left;">
				...
				<%if(haveMail.equals("1")){%><input type="checkbox" name="temp_sendNeedMailType_<%=eachActivityId%>"  id="temp_sendNeedMailType_<%=eachActivityId%>" value="1"><%=Resource.getValue(local,"workflow","workflow.EmailReminder")%>&nbsp;&nbsp;<%}%>
				</span>
